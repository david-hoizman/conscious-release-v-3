...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} className="snap-section relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-4 pb-12 md:pt-6 md:pb-0 animate-fade-in" style={{ animationDuration: '5s' }} dir="rtl">
